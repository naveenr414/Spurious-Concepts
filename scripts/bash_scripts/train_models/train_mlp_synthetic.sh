...
for i in 5 10 15
do 
    python train_cbm.py -dataset synthetic_object/synthetic_1 --encoder_model mlp -epochs 50 -num_attributes 2 -num_classes 2 --expand_dim_encoder $i --num_middle_encoder 2 -seed $seed 
done 

echo "Training with 3 middle encoders" 
for i in 5 10 15
do 
    python train_cbm.py -dataset synthetic_object/synthetic_1 --encoder_model mlp -epochs 50 -num_attributes 2 -num_classes 2 --expand_dim_encoder $i --num_middle_encoder 3 -seed $seed
done 